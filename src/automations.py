...
Handles automated tasks and system-level actions
triggered by assistant commands.
"""
from math import trunc
from os import startfile
from geopy.format import DISTANCE_FORMAT
from pyautogui import click, locate
...
def WhatsappMsg(name,message):
    ...
    startfile("")#location of the application
